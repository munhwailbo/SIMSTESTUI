...
Public Class PNB102_2_C_R
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ubiLease.UI.Reports.PN.PNB102_2_C_R.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPNB102_2_C_R
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PNB102_2_C_R = New PNB102_2_C_R()
        rpt.Site = Me.Site
        Return rpt
    End Function
