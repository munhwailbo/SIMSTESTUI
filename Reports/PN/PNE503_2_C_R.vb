...
Public Class PNE503_2_C_R
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ubiLease.UI.Reports.PN.PNE503_2_C_R.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPNE503_2_C_R
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PNE503_2_C_R = New PNE503_2_C_R()
        rpt.Site = Me.Site
        Return rpt
    End Function
