...
Public Class PNH103_2_C_R
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ubiLease.UI.Reports.PN.PNH103_2_C_R.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPNH103_2_C_R
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PNH103_2_C_R = New PNH103_2_C_R()
        rpt.Site = Me.Site
        Return rpt
    End Function
