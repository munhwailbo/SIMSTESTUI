...
Public Class PSB103_1_C_R
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ubiLease.UI.Reports.PS.PSB103_1_C_R.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPSB103_1_C_R
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PSB103_1_C_R = New PSB103_1_C_R()
        rpt.Site = Me.Site
        Return rpt
    End Function
