...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNE303
        ...
        Private Sub PNE303_BACK_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "||선택;선택;0;;1;" & "i;n;y;;;"
            gridAttributes = gridAttributes & "|접수일자;ContactDt4;85;yyyy-MM-dd;4;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|확장명;ExpandNm;1;;4;" & "o;n;n;4;"
            gridAttributes = gridAttributes & "|확장처코드;CompanyNm;114;;4;" & "o;n;n;4;"
            ...
            gridAttributes = gridAttributes & "|영업담당자;EmployeeNm;74;;1;" & "o;n;n;50;"
            gridAttributes = gridAttributes & "|주권유자;TrAdEmployeeNm;62;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|권유자명;BizEmpNm;62;;4;" & "o;n;n;7;"
            gridAttributes = gridAttributes & "|권유자부서;DeptNm;75;;1;" & "o;n;n;50;"
            gridAttributes = gridAttributes & "|신규확장;NewExpPapNum;62;#,##0;7;" & "o;n;n;50;"
            gridAttributes = gridAttributes & "|재확장;ReExpPapNum;50;#,##0;7;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|접수계;TargetPaperTotNum;50;#,##0;7;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|수금형태코드;CollectionDivCd;87;;1;" & "o;n;n;50;"
            gridAttributes = gridAttributes & "|청구방법코드;BillDivCd;87;;1;" & "o;n;n;10;"
            ...
            gridAttributes = gridAttributes & "|접수;ContactDt4;85;;4;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|확장처;CompanyNm;119;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|투입처;DeliveryChnlNm;128;;1;" & "o;n;y;30;"
            gridAttributes = gridAttributes & "|독자명;SubscriberNm;191;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|전화1;PhoneNum1;116;;1;" & "o;n;n;10;"
            'gridAttributes = gridAttributes & "|핸드폰;MobileNum;116;;1;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|주소;OldAddr1;231;;1;" & "o;n;n;30;"
...
#Region "라디오버튼 이벤트"
        Private Sub optReceipt_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optReceipt.CheckedChanged
            If optReceipt.Checked = True Then
        ...
        Private Sub optMonitor_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optMonitor.CheckedChanged
            If optMonitor.Checked = True Then
        ...
        Private Sub optstop_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optstop.CheckedChanged
            If optstop.Checked = True Then
                Me.Grd_3.Visible = True
                Me.Grd_1.Visible = False
                Me.Grd_2.Visible = False
                Me.grd_4.Visible = False
                Me.grd_5.Visible = False
        ...
        Private Sub optHeadOfficeDelivery_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optHeadOfficeDelivery.CheckedChanged

            If optHeadOfficeDelivery.Checked = True Then
                ...
                Me.btnExcelExport.Visible = True
            End If

        End Sub

        Private Sub optBranchDelivery_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optBranchDelivery.CheckedChanged

            If optBranchDelivery.Checked = True Then
