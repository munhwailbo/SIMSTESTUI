...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Partial Class PNH202
        ...
        Public Sub NewData()
            ...
            Me.cboClosingType.TextValue = "04"
        ...
        Public Function GetCloseDate(Optional ByVal AprocessMessage As Boolean = True) As Boolean
            ...
            'Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNH202_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If MsgBox(message & vbCrLf & "마감 처리 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNH202_CUD", True, False, GmainsqlParameters)
