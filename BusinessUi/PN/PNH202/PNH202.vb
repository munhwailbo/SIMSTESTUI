...
#Region "폼 이벤트"
        ...
        ''' <param name="e"></param>
        ''' <remarks></remarks>
        Private Sub PNH202_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#End Region
        ...
        Private Sub btnClosing_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClosing.Click
            ...
            If Me.dtpNextClosingYearMonths.TextValue Is Nothing Then
                MessageBox.Show("최종 마감 정보를 조회 후 처리 하세요", "부수조정 마감 처리경고")
                Exit Sub
            Else
                Me.SaveData()
                'MessageBox.Show("부수조정 마감 처리 됐습니다")
                Me.RequestData()
            End If
        ...
        Private Sub btnClosingCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClosingCancel.Click
            ...
            Else
                Me.DeleteData()
                MessageBox.Show("부수조정 마감취소 처리 됐습니다")
                Me.RequestData()
            End If
