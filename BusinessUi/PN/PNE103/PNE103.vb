...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNE103
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|확장일자;ExpandDt;85;yyyy-MM-dd;4;" & "o;n;n;5;"
            gridAttributes = gridAttributes & "|순번;Orders;0;;4;" & "o;n;y;5;"
            gridAttributes = gridAttributes & "|승인여부;ApprovalYN;62;;4;" & "io;n;n;40;"
            gridAttributes = gridAttributes & "|승인일자;ApprovalDt;62;yyyy-MM-dd;4;" & "io;n;n;40;"
            gridAttributes = gridAttributes & "|확장명;ExpandNm;100;;100;" & "o;n;n;40;"
            gridAttributes = gridAttributes & "|확장처코드;CompanyCd;98;;4;" & "o;n;n;40;확장처 명;CompanyNm"
            gridAttributes = gridAttributes & "|확장처명;CompanyNm;155;;1;" & "o;n;n;40;"
            gridAttributes = gridAttributes & "|수금형태코드;CollectionDivCd;87;;1;" & "o;n;n;40;"
            gridAttributes = gridAttributes & "|청구방법코드;BillDivCd;93;;1;" & "o;n;n;5;"
            gridAttributes = gridAttributes & "|청구주기코드;BillPeriodCd;87;;1;" & "o;n;n;5;"
            ...
            gridAttributes = gridAttributes & "|확정;FixedPaperNum;37;#,###;7;" & "o;n;n;5;"
            gridAttributes = gridAttributes & "|투입;SubscribePagerNum;37;#,###;7;" & "o;n;y;5;"  '임시 변경   02.18
            gridAttributes = gridAttributes & "|미투입;NoSubscribePagerNum;50;#,###;7;" & "o;n;y;5;" '임시 변경 02.18
            gridAttributes = gridAttributes & "|비고;Note;363;;4;" & "o;n;n;40;"
            ...
            gridAttributes = gridAttributes & "|신규;NewConPaperNum;37;#,##0;4;" & "o;n;n;4;"
            gridAttributes = gridAttributes & "|재확장;ReConPaperNum;50;#,##0;4;" & "o;n;n;4;"
            gridAttributes = gridAttributes & "|접수계;ContactPaperNum;50;#,##0;4;" & "o;n;n;4;"
            gridAttributes = gridAttributes & "|권유자명;AdEmployeeNm;62;;4;" & "o;n;n;7;"
            gridAttributes = gridAttributes & "|권유자부서;AdEmployeeDeptNm;74;;4;" & "o;n;n;7;"
            gridAttributes = gridAttributes & "|전화1;PhoneNum1;116;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|핸드폰;MobileNum;50;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|우편번호;OldPostNum;62;;4;" & "o;n;n;10;우편번호;OldAddr1"
            gridAttributes = gridAttributes & "|주소;OldAddr1;221;;1;" & "o;n;n;50;"
            gridAttributes = gridAttributes & "|상세주소;OldAddr2;266;;1;" & "o;n;n;100;"
            gridAttributes = gridAttributes & "|투입지국코드;DeliveryBranchCd;87;;4;" & "o;n;n;7;지국코드;DeliveryBranchNm"
            gridAttributes = gridAttributes & "|투입지국명;DeliveryBranchNm;74;;1;" & "o;n;n;7;"
            gridAttributes = gridAttributes & "|지국전달사항;BranchNote;162;;1;" & "o;n;n;200;"
            ...
            gridAttributes = gridAttributes & "|(모)처리코드;MonitoringResultCd;84;;1;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|(모)미통과사유코드;RefuseReasonCd;121;;1;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|(모)처리자사번;MonitoringEmpNum;96;;1;" & "o;n;n;7;"
            gridAttributes = gridAttributes & "|(모)처리자명;MonitoringEmpNm;84;;1;" & "o;n;n;7;"
            gridAttributes = gridAttributes & "|(모)처리일자;MonitoringProcDt;84;yyyy-MM-dd;4;" & "o;n;n;8;"
            gridAttributes = gridAttributes & "|권유자통보여부;NotifyYN;99;;1;" & "o;n;n;1;"
            gridAttributes = gridAttributes & "|권유자통보일자;SolicitorNotifyDt;99;yyyy-MM-dd;4;" & "o;n;n;8;"
            gridAttributes = gridAttributes & "|비고;Note;37;;1;" & "o;n;n;1000;"
            ...
            '화면 명칭; key 명칭; 넓이; format; 정렬(l - flexAlignLeftCenter, c - flexAlignCenterCenter, r - flexAlignRightCenter);
            '& input outup(i - input, o - output, io - input output); 필수 입력(y - yes, n - no); 숨기기 (y - yes, n - no); 최대 문자 길이; popup code
            'gridAttributes = gridAttributes & "|l선택;선택;40;;1;" & "i;n;n;"
            'gridAttributes = gridAttributes & "|사원확장번호;EmployeeExpNum;0;#,###;4;" & "io;n;y;12;"
            'gridAttributes = gridAttributes & "|일련번호;SeriesNum;0;#,###;7;" & "io;n;y;5;"
            'gridAttributes = gridAttributes & "|권유자구분코드;SolicitorDivCd;99;;1;" & "io;n;n;5;"
            'gridAttributes = gridAttributes & "|권유자코드;SolicitorEmpNum;74;;4;" & "io;n;n;5;사원 명;EmployeeNameHangul,SoliDeptCd,SoliDeptNm"
            'gridAttributes = gridAttributes & "|사원명;EmployeeNameHangul;50;;1;" & "o;n;n;5;"
            'gridAttributes = gridAttributes & "|권유부서코드;SoliDeptCd;87;;4;" & "io;n;n;40;부서 명;SoliDeptNm "
            'gridAttributes = gridAttributes & "|권유부서명;SoliDeptNm;74;;1;" & "o;n;n;40;"
            'gridAttributes = gridAttributes & "|신규확장;FixedPaperNum;62;#,###;7;" & "io;n;n;5;"
            'gridAttributes = gridAttributes & "|재확장;ReFixedPaperNum;50;#,###;7;" & "io;n;n;5;"
            'gridAttributes = gridAttributes & "|사원확장;TargetPaperTotNum;62;#,###;7;" & "io;n;n;5;"
            'gridAttributes = gridAttributes & "|권유자정보;RealSolicitorInfo;0;;4;" & "io;n;y;40;"
            ...
            gridAttributes = gridAttributes & "|권유자구분코드;SolicitorDivCd;99;;c;" & "io;n;n;5;"
            ...
            gridAttributes = gridAttributes & "|권유부서코드;SoliDeptCd;87;;c;" & "io;n;n;40;부서 명;SoliDeptNm;"
            gridAttributes = gridAttributes & "|권유부서명;SoliDeptNm;80;;l;" & "o;n;n;40;"
            gridAttributes = gridAttributes & "|신규확장;FixedPaperNum;65;#,##0;r;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|재확장;ReFixedPaperNum;55;#,##0;r;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|사원확장;TargetPaperTotNum;65;#,##0;r;" & "io;n;n;5;"
