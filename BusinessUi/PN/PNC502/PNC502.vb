...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNC502
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|독자키;vPkey;60;;c;" & "io;n;y;12;"
            gridAttributes = gridAttributes & "|모니터일자;ReceiptDt;70;;l;" & "o;n;n;40;"
            gridAttributes = gridAttributes & "|모니터일자2;MonitorDt;70;;l;" & "io;n;y;40;"
            gridAttributes = gridAttributes & "|순번;Orders;40;;l;" & "io;n;n;"
            ...
            gridAttributes = gridAttributes & "|우편번호;PostNum;60;;l;" & "o;n;y;5;"
            ...
            'gridAttributes = gridAttributes & "|확장처코드;CompanyCd;60;;l;" & "o;n;n;5;확장처 명;CompanyNm"
            gridAttributes = gridAttributes & "|확장처명;CompanyHangulNm;60;;l;" & "o;n;n;5;"
            ...
            gridAttributes = gridAttributes & "|부수;ContactPaperNum;60;;l;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|투입부수;SubscribePagerNum;60;;l;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|미투입부수;NoSubscribePagerNum;60;;l;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|확인불가;NoConnectPagerNum;60;;l;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|모니터결과;MonitorResultCd;60;;l;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|통화내용;Remark;60;;l;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|모니터종료일자;MonitorResaultDt;60;yyyy-MM-dd;l;" & "io;n;n;5;"
