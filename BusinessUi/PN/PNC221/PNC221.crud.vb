    ...
    Partial Class PNC221
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC221_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            ...
            ''        '' ''.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNum"), .get_ColIndex("ColAmt"), "{0} 소계")
            ...
            ''        ' '' ''.set_MergeCol(Me.grd_1.get_ColIndex("ChargeEmpNm"), True)
            ''        '' ''.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("ChargeEmpNm"), .get_ColIndex("ColAmt"), "{0} 소계")
            ''        '' '' ''For intII As Integer = 1 To 9
            ''        '' '' ''    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("ChargeEmpNm"), .get_ColIndex("ColAmt_" & intII.ToString), "{0} 소계")
            ''        '' '' ''Next
            ''        ' '' '' '' =============================================================================
        ...
        Public Sub SaveData()
            ...
            ' '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC221_CUD", True, False, GmainsqlParameters)
            ' '' ''    .SetAllBusinessUiInitialValue(Me)
            ' '' ''    '' .SaveDataMessage(Me)
            ' '' ''End With
