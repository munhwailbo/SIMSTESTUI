...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNE451
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|(A)청구대상총액;Amount_A;90;#,##0;7;" & "o;n;n;15;"
            gridAttributes = gridAttributes & "|(B)총청구액;Amount_B;90;#,##0;7;" & "o;n;n;15;"
            gridAttributes = gridAttributes & "|(C)미청구총액;Amount_C;90;#,##0;7;" & "o;n;n;15;"
            gridAttributes = gridAttributes & "|(D)미청구액;Amount_D;0;#,##0;4;" & "o;n;y;15;"
            gridAttributes = gridAttributes & "|(E)수금총액;Amount_E;90;#,##0;7;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|(F)미수금액;Amount_F;90;#,##0;7;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|(G)배분;Amount_G;90;#,##0;7;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|(H)미배분;Amount_H;90;#,##0;7;" & "o;n;n;10;"
