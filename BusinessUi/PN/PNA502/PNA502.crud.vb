    ...
    Partial Class PNA502
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AZipCd", Me.PopZipCd.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@ABranchCd", Me.PopBranchCd.CodeText)
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA502_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            '    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA502_CUD", True, False, GmainsqlParameters)
            '    .SetAllBusinessUiInitialValue(Me)
            '    '' .SaveDataMessage(Me)
            'End With
