    ...
    Partial Class PNE602
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AExpandYearMonthFr", Me.dtpExpandYearMonthFr.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@AExpandYearMonthTo", Me.dtpExpandYearMonthTo.TextValue)
                '.SetSqlParameter(GmainsqlParameters, "@AEmployeeDeptCd", Me.popEmployeeDeptCd.TextValue)

                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE602_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE602_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    .set_TextMatrix(.FixedRows, .get_ColIndex("SoliDeptName_2"), "합   계")
