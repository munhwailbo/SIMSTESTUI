...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|비고;Note;85;;4;" & "o;n;n;10;"
            ...
            '' 2010.05.19 임시로 팀장 제어 처리  (김상배, 김선일, 김영남)
            If GmainBusinessFunction.GetValue("로그인 ID") = "960843" _
                      Or GmainBusinessFunction.GetValue("로그인 ID") = "010496" _
                      Or GmainBusinessFunction.GetValue("로그인 ID") = "990486" Then
                popEmployeeNumber.Enabled = True
            End If
            '' =============================================================
...
#Region "폼 이벤트"
        ...
        ''' <param name="e"></param>
        ''' <remarks></remarks>
        Private Sub PNC204_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
