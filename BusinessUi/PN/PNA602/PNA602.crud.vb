    ...
    Partial Class PNA602
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA602_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            '    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA602_CUD", True, False, GmainsqlParameters)
            '    .SetAllBusinessUiInitialValue(Me)
            '    '' .SaveDataMessage(Me)
            'End With
        ...
        Public Sub ExportData()
         ...
         '       .SetExportCrystalDataParameter("PNA602.rpt", "PNA602_R", "", AsqlParameters, AformulaParameters)
         '   End With
