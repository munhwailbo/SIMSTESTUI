...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNA602
        ...
        Private Sub PNA602_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|비고;Note;200;;l;" & "io;n;n;1000;"       '(30)
            'grid_1 code combo    
            Dim gridCodeNameList As String = ""
            gridCodeNameList = gridCodeNameList & "BizTypeCd;휴간구분 명"
