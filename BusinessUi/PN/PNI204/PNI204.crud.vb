    ...
    Partial Class PNI204
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@ACollectYYYYMM", Me.dtpCalYearMonths.TextValue)
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI204_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            ...
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    For intII As Integer = .get_ColIndex("UnColAmt") To .get_ColIndex("DepositAmt2")
        ...
        Public Sub SaveData()
            ...
            '    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI204_CUD", True, False, GmainsqlParameters)
            '    .SetAllBusinessUiInitialValue(Me)
            '    '' .SaveDataMessage(Me)
            'End With
        ...
        Public Sub ExportData()
            ...
            If optExpAmt1.Checked = True Then
                With GmainCommonFunction
                    .SetSqlParameter(AsqlParameters, "@ACollectYYYYMM", Me.dtpCalYearMonths.TextValue)
                    ...
                    .SetExportCrystalDataParameter("PNI204_1_C_R.rpt", "PNI204_1_C_R", "", AsqlParameters, AformulaParameters)
                End With
            ...
            ElseIf optExpAmt2.Checked = True Then
                With GmainCommonFunction
                    ...
                    ' 공통변수의정의가생성시에발생될수있도록유도한다.
                    .SetExportCrystalDataParameter("PNI204_2_C_R.rpt", "PNI204_2_C_R", "", AsqlParameters, AformulaParameters)
