...
Namespace ubiLease.UI.BusinessUi.PN
    Partial Class PNE302
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE302_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE302_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            ' '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE302_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData()
            ...
            '' '' ''        .SetExportCrystalDataParameter("PNE302_1_C_R.rpt", "PNE302_1_C_R", "", AsqlParameters, AformulaParameters)
            '' '' ''    End With
            ...
            '' '' ''        ' 공통변수의정의가생성시에발생될수있도록유도한다.
            '' '' ''        .SetExportCrystalDataParameter("PNE302_2_C_R.rpt", "PNE302_2_C_R", "", AsqlParameters, AformulaParameters)
            '' '' ''    End With
            ...
            '' '' ''        ' 공통변수의정의가생성시에발생될수있도록유도한다.
            '' '' ''        .SetExportCrystalDataParameter("PNE302_3_C_R.rpt", "PNE302_3_C_R", "", AsqlParameters, AformulaParameters)
            '' '' ''    End With
            '' '' ''End If
        End Sub
    End Class
