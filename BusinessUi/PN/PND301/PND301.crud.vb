    ...
    Partial Class PND301
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AMtOrders", Me.txtMtOrders.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@APromotionNm", Me.TxtPromotionNm.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@ACompanyCd", Me.PopCompanyCd.TextValue)
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PND301_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PND301_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
