    ...
    Partial Class PNA601
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA601_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA601_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
        ...
        Public Sub ExportData()
         ...
         '       .SetExportCrystalDataParameter("PNA601.rpt", "PNA601_R", "", AsqlParameters, AformulaParameters)
         '   End With
