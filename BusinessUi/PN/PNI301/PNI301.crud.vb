    ...
    Partial Class PNI301
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI301_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI301_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI301_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub DeleteData()
            ...
            If MsgBox("삭제하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                '' ''GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AColAccountNum", Me.txtColAccountNum.TextValue)  '' 입금계좌번호 
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ARecipient", Me.txtRecipient.TextValue)  '' 입금자명     
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", IIf(IsNothing(Me.dtpCalYearMonths.TextValue), "", Me.dtpCalYearMonths.TextValue))  ''지대입금년월 
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AColYearMonths", IIf(IsNothing(Me.dtpColYearMonths.TextValue), "", Me.dtpColYearMonths.TextValue))  ''지대수금년월 
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AEmployeeExpNum", popEmployeeExpNum.TextValue)  '' 사원확장번호
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACompanyCd", Me.popCompanyCd.TextValue)  '' 확장처코드 
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AColAmt", Me.numColAmt.TextValue)  '' 입금금액     
        ...
        Public Sub ExportData()
            ...
            With GmainCommonFunction
                ...
                .SetExportCrystalDataParameter("PNI301_1_C_R.rpt", "PNI301_1_C_R", "", AsqlParameters, AformulaParameters)
            End With
