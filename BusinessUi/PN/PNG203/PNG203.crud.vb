    ...
    Partial Class PNG203
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AYYYYMM", Me.dtpBaseDt_R1.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@ABranchNum", Me.popBranchNum.TextValue)
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNG203_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNG203_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
        ...
        Public Sub ExportData()
         ...
         '       .SetExportCrystalDataParameter("PNG203.rpt", "PNG203_R", "", AsqlParameters, AformulaParameters)
         '   End With
