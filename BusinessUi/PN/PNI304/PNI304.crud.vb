...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Partial Class PNI304
        ...
        Public Sub NewData()
            ...
            Me.cboClosingType.TextValue = "04"    '' 수납 마감
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            GmainsqlParameters = Nothing
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AClosingType", "05")  '' '' 05:지대완납적립금 Me.cboClosingType.TextValue)

                '' ''Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "GetMaxCloseDate", False, True, GmainsqlParameters)
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "GetMaxCloseDate", False, True, GmainsqlParameters)
                '' ''GmainCommonFunction.SetDataSetToControls(reciveDataSet, Me)
                dtpClosingYearMonths2.TextValue = reciveDataSet.Tables(0).Rows(0).Item("ClosingYearMonths").ToString()
                dtpNextClosingYearMonths2.TextValue = reciveDataSet.Tables(0).Rows(0)("NextClosingYearMonths").ToString()
                dtpClosingDt2.TextValue = reciveDataSet.Tables(0).Rows(0)("ClosingDt").ToString()
                reciveDataSet = Nothing
                .SetAllBusinessUiInitialValue(Me)
                If AprocessMessage = True Then .RequestDataMessage(Me)
            End With
        ...
        Public Function GetCloseDate(Optional ByVal AprocessMessage As Boolean = True) As Boolean
            ...
            'Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI304_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If MsgBox(message & vbCrLf & "마감 처리 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI304_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub SaveData2()
            Dim message As String = Me.dtpNextClosingYearMonths2.TextValue.Substring(0, 4) & "년 " & Me.dtpNextClosingYearMonths2.TextValue.Substring(4, 2) & "월"
            If MsgBox(message & vbCrLf & "마감 처리 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                GmainsqlParameters = Nothing

                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ArecordprocessMode", "1")
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingYearMonths", Me.dtpNextClosingYearMonths2.TextValue)  ' 마감 시는 마감 할 년월
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingDt2", Me.dtpClosingDt2.TextValue)  ' 적립금 적용 일자
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingType", "05")  ' '' 05:지대완납적립금 산정
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingMode", "1")  '' '' 1:마감처리 , 2: 마감취소
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AloginId", GmainBusinessFunction.GetValue("로그인 ID"))

                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI304_2_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub DeleteData2()
            ...
            Dim message As String = Me.dtpClosingYearMonths2.TextValue.Substring(0, 4) & "년 " & Me.dtpClosingYearMonths2.TextValue.Substring(4, 2) & "월"
            If MsgBox(message & vbCrLf & "적립금 취소 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then

                GmainsqlParameters = Nothing

                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ArecordprocessMode", "3")
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingYearMonths", Me.dtpClosingYearMonths2.TextValue)  '마감 취소 시는 마감되어 있는 년월
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingDt2", Me.dtpClosingDt2.TextValue)  ' 적립금 적용 일자
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingType", "05")  ' '' 05:지대완납적립금 산정
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AClosingMode", "2")  '' '' 1:마감처리 , 2: 마감취소
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AloginId", GmainBusinessFunction.GetValue("로그인 ID"))
