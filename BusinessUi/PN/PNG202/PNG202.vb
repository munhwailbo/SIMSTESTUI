...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|구분;TreePath;72;;1;" & "o;n;n;5;"
            gridAttributes = gridAttributes & "|정산년월;YYYYMM;63;yyyy-MM;4;" & "io;n;n;6;"
            gridAttributes = gridAttributes & "|담당사번;ChargeEmpNum;1;;4;" & "o;n;n;9;담당사번;ChargeEmpNm"
            gridAttributes = gridAttributes & "|담당명;ChargeEmpNm;50;;1;" & "o;n;n;9;"
            gridAttributes = gridAttributes & "|정산일자;CalDt;0;yyyy-MM-dd;4;" & "io;n;y;20;"
            gridAttributes = gridAttributes & "|지국번호;BranchNum;1;;4;" & "io;n;n;9;지국번호;BranchNumNm"
            gridAttributes = gridAttributes & "|지국명;BranchNumNm;62;;1;" & "o;n;n;9;"
            gridAttributes = gridAttributes & "|지원항목코드;DivCd;87;;4;" & "io;n;y;10;지원항목 명;DivNm"
            gridAttributes = gridAttributes & "|지원항목명;DivNm;99;;1;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|담당확인여부;RegYesOrNo;87;;1;" & "io;n;n;8;"
            gridAttributes = gridAttributes & "|관리승인여부;ApplyYesOrNo;0;;1;" & "o;n;y;8;"
            gridAttributes = gridAttributes & "|부수;PaperNum;0;#,##0;7;" & "o;n;y;4;"
            gridAttributes = gridAttributes & "|단가;UnitCost;0;#,##0;7;" & "o;n;y;15;"
            gridAttributes = gridAttributes & "|지원비금액;SupAmt;74;#,##0;7;" & "o;n;n;15;"
            gridAttributes = gridAttributes & "|대체일자;DeductDt;0;yyyy-MM-dd;4;" & "o;n;y;4;"
