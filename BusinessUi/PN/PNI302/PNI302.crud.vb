    ...
    Partial Class PNI302
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AChargeEmpNum_R", Me.popChargeEmpNum_R.TextValue)
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ABranchCd_R", Me.popBranchCd_R.TextValue)

                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI302_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI302_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ABranchCd", Me.popBranchCd.TextValue)  '' 지대지국코드 
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI302_CUD", True, False, GmainsqlParameters)
