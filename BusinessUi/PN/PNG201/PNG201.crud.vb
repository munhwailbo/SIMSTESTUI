    ...
    Partial Class PNG201
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                .SetSqlParameter(GmainsqlParameters, "@AChargeEmpNum_R", Me.txtChargeEmpNum_R.TextValue)
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNG201_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            ...
            End With
        End Sub
        'gridAttributes = gridAttributes & "|부수;PaperNum;40;#,##0;r;" & "io;n;y;4;"       '(50)
        '   gridAttributes = gridAttributes & "|단가;UnitCost;150;#,##0;r;" & "io;n;y;15;"       '(60)
        '   gridAttributes = gridAttributes & "|지원비금액;SupAmt;150;#,##0;r;" & "io;n;n;15;"       '(70)
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNG201_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
