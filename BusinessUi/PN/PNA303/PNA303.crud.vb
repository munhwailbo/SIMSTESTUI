...
Namespace ubiLease.UI.BusinessUi.PN
    Partial Class PNA303
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA303_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            '    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA303_CUD", True, False, GmainsqlParameters)
