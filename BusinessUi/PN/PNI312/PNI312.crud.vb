    ...
    Partial Class PNI312
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI312_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI312_CUD", True, False, GmainsqlParameters)
            '' ''    .SetAllBusinessUiInitialValue(Me)
            '' ''    '' .SaveDataMessage(Me)
            '' ''End With
