...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNE461
        ...
        Private Sub PNE461_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Public Sub grd_2_Initialize()
            ...
            gridAttributes = gridAttributes & "|확장명;ExpandNm;1;;l;" & "o;n;n;50;"
            gridAttributes = gridAttributes & "|확장처코드;CompanyCd;1;;4;" & "io;n;n;40;확장처 명;CompanyNm"
            ...
            gridAttributes = gridAttributes & "|단가;SubsUnitAmt;60;#,##0;c;" & "io;n;n;4;"       '(80)
            gridAttributes = gridAttributes & "|본사수금구독료;SubscriptionAmt;100;#,##0;r;" & "io;n;n;4;"       '(80)

            gridAttributes = gridAttributes & "|배분년월;DisYearMonths;80;;l;" & "io;n;n;6;"       '(20)
            ''gridAttributes = gridAttributes & "|배분년월;DisYearMonths2;80;;l;" & "io;n;y;6;"       '(20)
        ...
        ''' <param name="e"></param>
        ''' <remarks></remarks>
        Private Sub PNE461_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Enter
