    ...
    Partial Class PNE461
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE461_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE461_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            If Me.grd_1.GetCurrentRowCellValue("BillPeriodCd") <> "4" Or (Me.grd_1.GetCurrentRowCellValue("BillPeriodCd") = "4" And (Me.dtpBaseDt_R.TextValue <> Me.grd_1.GetCurrentRowCellValue("DistributionMM"))) Then
                GmainsqlParameters = Nothing
                With GmainCommonFunction
                    .SetSqlParameter(GmainsqlParameters, "@ABaseYearMonths", Me.grd_1.GetCurrentRowCellValue("DmdYYMM"))
                    .SetSqlParameter(GmainsqlParameters, "@ABaseDt", Me.dtpBaseDt2_R.TextValue)
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE461_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
