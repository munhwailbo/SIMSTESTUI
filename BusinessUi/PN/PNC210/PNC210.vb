...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|독자번호;Pkey;89;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|순번;Seq;0;;1;" & "o;n;y;30;"
            gridAttributes = gridAttributes & "|구분;gb;43;;4;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|독자코드;ReceiptCd;107;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|독자명;SubscriberNm;107;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|접수상태;StateKang;102;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|전화번호1;PhoneNum1;99;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|주소;Addr;145;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|지국명;BranchName;145;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|영업담당;BranchName;145;;1;" & "o;n;n;30;"
            'DeliveryBranchCd

            'gridAttributes = gridAttributes & "|투입지국명;DeliveryBranchNm;162;;1;" & "o;n;n;30;"
...
#Region "폼 이벤트"
        ...
        ''' <param name="e"></param>
        ''' <remarks></remarks>
        Private Sub PNC210_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
