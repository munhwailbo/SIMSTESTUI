    ...
    Partial Class PNE441
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE441_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE441_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE441_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData()
            ...
            With GmainCommonFunction
                ...
                .SetExportCrystalDataParameter("PNE441_1_C_R.rpt", "PNE441_1_C_R", "", AsqlParameters, AformulaParameters)
            End With
