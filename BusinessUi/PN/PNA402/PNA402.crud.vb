...
Namespace ubiLease.UI.BusinessUi.PN
    Partial Class PNA402
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            'GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProjectID", Me.txtProjectID.TextValue)


            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA402_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If MsgBox("저장하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA402_CUD", True, False, GmainsqlParameters)
