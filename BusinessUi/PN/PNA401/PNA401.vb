...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNA401
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|우편번호;PostNum;70;;c;" & "io;n;y;40;우편번호;CodeHangulName"
            gridAttributes = gridAttributes & "|주소;Addr1;120;;l;" & "io;n;y;5;"
            gridAttributes = gridAttributes & "|상세주소;Addr2;100;;l;" & "io;n;y;5;"
            gridAttributes = gridAttributes & "|업태;BusiStatus;60;;c;" & "io;n;y;5;"
            gridAttributes = gridAttributes & "|사업자번호;BusinessNum;60;;c;" & "io;n;y;5;"
            gridAttributes = gridAttributes & "|대표자명;CorparationNm;60;;c;" & "io;n;y;5;"
            gridAttributes = gridAttributes & "|종목;BusiType;70;;c;" & "io;n;y;40;"
            gridAttributes = gridAttributes & "|담당자정보;ExChargeEmpInfo;70;;c;" & "io;n;y;40;"
            gridAttributes = gridAttributes & "|담당자연락처;ExChargeEmpPhoneNum1;60;;c;" & "io;n;y;5;"
