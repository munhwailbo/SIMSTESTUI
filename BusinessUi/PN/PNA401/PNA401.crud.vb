...
Namespace ubiLease.UI.BusinessUi.PN
    Partial Class PNA401
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AParentCompanyCd", Me.popParentCompanyCd.TextValue)

            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA401_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If MsgBox("저장하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA401_CUD", True, False, GmainsqlParameters)
