...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Partial Class PNC207
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            If blnRequestYesOrNo Then
                ...
                With GmainCommonFunction
                    ...
                    .SetSqlParameter(GmainsqlParameters, "@AReceiptDtFrom", Me.dtpReceiptDtFrom.TextValue)  '' 확장일자
                    .SetSqlParameter(GmainsqlParameters, "@AReceiptDtTo", Me.dtpReceiptDtTo.TextValue)
                    .SetSqlParameter(GmainsqlParameters, "@ARealEdDtFrom", Me.dtpRealEdDtFrom.TextValue)  '' 중지일자
                    .SetSqlParameter(GmainsqlParameters, "@ARealEdDtTo", Me.dtpRealEdDtTo.TextValue)
                    ...
                    Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC207_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC207_CUD", True, False, GmainsqlParameters)
            '' ''    .SetAllBusinessUiInitialValue(Me)
            '' ''    '' .SaveDataMessage(Me)
            '' ''End With
