    ...
    Partial Class PNC231
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AbastDtFr", Me.dtpbastDtFr.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@AbastDtTo", Me.dtpbastDtTo.TextValue)
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC231_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    ' ''.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNum"), .get_ColIndex("TotExpNum"), "{0} 소계")
                    For intII As Integer = .get_ColIndex("BalPapNum") To .get_ColIndex("GuExpNum")
                    ...
                    '.set_MergeCol(Me.grd_1.get_ColIndex("ChargeEmpNm"), True)
                    ''.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("ChargeEmpNm"), .get_ColIndex("TotExpNum"), "{0} 소계")
                    For intII As Integer = .get_ColIndex("BalPapNum") To .get_ColIndex("GuExpNum")
                        .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("ChargeEmpNm"), intII, "{0} 소계")
                    Next
                    ' '' =============================================================================
                    ...
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("ChargeEmpNm"), "합 계")
                    ' ''.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("TotExpNum"), "합 계")
                    For intII As Integer = .get_ColIndex("BalPapNum") To .get_ColIndex("GuExpNum")
        ...
        Public Sub SaveData()
            ...
            ' '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC231_CUD", True, False, GmainsqlParameters)
            ' '' ''    .SetAllBusinessUiInitialValue(Me)
            ' '' ''    '' .SaveDataMessage(Me)
            ' '' ''End With
