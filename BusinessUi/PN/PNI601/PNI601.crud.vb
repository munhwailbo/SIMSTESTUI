    ...
    Partial Class PNI601
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AslipDivision", Me.cboSlipDivision.TextValue)     '전표 유형
                .SetSqlParameter(GmainsqlParameters, "@AslipDateSt", Me.DtpSlipDateSt.TextValue)         '회계 일자
                .SetSqlParameter(GmainsqlParameters, "@AslipDateEd", Me.DtpSlipDateEd.TextValue)         '회계 일자
                .SetSqlParameter(GmainsqlParameters, "@AloginId", GmainBusinessFunction.GetValue("로그인 ID"))
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI601_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI991_CUD", True, False, GmainsqlParameters)
            '' ''    .SetAllBusinessUiInitialValue(Me)
            '' ''    '' .SaveDataMessage(Me)
            '' ''End With
        ...
        Public Sub SlipData()
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@AloginId", GmainBusinessFunction.GetValue("로그인 ID"))
                .SetSqlParameter(GmainsqlParameters, "@AyearMonth", Me.DtpExpDate.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@AslipDate", Me.dtpSlipDate.TextValue)
                .SetSqlParameter(GmainsqlParameters, "@ArecordProcessMode", "1")
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI601_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData()
            ...
            '       .SetExportCrystalDataParameter("PNI991.rpt", "PNI991_R", "", AsqlParameters, AformulaParameters)
            '   End With
