    ...
    Partial Class PND303
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PND303_R", False, True, GmainsqlParameters)
        ...
        '        GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PND303_CUD", True, False, GmainsqlParameters)
        '        .SetAllBusinessUiInitialValue(Me)
        '        '' .SaveDataMessage(Me)
        '    End With
