...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNE301
        ...
        Private Sub PNE301_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|확장구분;ExpandDivCd;73;;c;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|독자상태코드;ReaderStateCd;87;;1;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|구독상태코드;SubscribeStateCd;87;;1;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|독자명;SubscriberNm;206;;1;" & "o;n;n;30;"
            ...
            gridAttributes = gridAttributes & "|주소;OldAddr1;212;;1;" & "o;n;n;50;"
            gridAttributes = gridAttributes & "|상세주소;OldAddr2;293;;1;" & "o;n;n;100;"
            ...
            gridAttributes = gridAttributes & "|권유부서명;AdEmployeeDeptNm;74;l;1;" & "o;n;n;7;"
            ...
            gridAttributes = gridAttributes & "|확장처명;CompanyNm;133;;1;" & "o;n;n;10;"
            gridAttributes = gridAttributes & "|투입처코드;DeliveryChnlCd;0;;1;" & "o;n;y;10;"
            gridAttributes = gridAttributes & "|투입처명;DeliveryChnlNm;133;;1;" & "o;n;n;10;"
            ...
            gridAttributes = gridAttributes & "|소속사코드;CouponSeriesNum;0;;1;" & "o;n;y;10;"
            gridAttributes = gridAttributes & "|전화번호2;PhoneNum2;69;;1;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|주권유자;TrAdEmployeeNum;62;c;1;" & "o;n;n;7;"
