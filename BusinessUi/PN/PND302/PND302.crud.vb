    ...
    Partial Class PND302
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PND302_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PND302_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
