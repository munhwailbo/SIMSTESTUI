    ...
    Partial Class PNI991
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI991_R", False, True, GmainsqlParameters)
        ...
        ' ''Public Sub GrdSetColor()

        ' ''    With Me.grd_1
        ' ''        If .Rows > 1 Then
        ' ''            For intRow As Integer = .FixedRows To .Rows - 1
        ' ''                If .get_TextMatrix(intRow, .get_ColIndex("WeekDays")) = "일요일" Then
        ' ''                    For intCol As Integer = 1 To .Cols - 1
        ' ''                        .set_Cell(C1.Win.C1FlexGrid.Classic.CellPropertySettings.flexcpBackColor, intRow, intCol, intRow, .Cols - 1, Color.Pink)
        ' ''                    Next
        ' ''                ElseIf .get_TextMatrix(intRow, .get_ColIndex("WeekDays")) = "토요일" Then
        ' ''                    For intCol As Integer = 1 To .Cols - 1
        ' ''                        .set_Cell(C1.Win.C1FlexGrid.Classic.CellPropertySettings.flexcpBackColor, intRow, intCol, intRow, .Cols - 1, Color.LightBlue)
        ' ''                    Next
        ' ''                End If
        ' ''            Next
        ' ''        End If
