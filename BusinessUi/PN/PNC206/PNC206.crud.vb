...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Partial Class PNC206
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            If blnRequestYesOrNo Then
                ...
                With GmainCommonFunction
                    ...
                    Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC206_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC206_CUD", True, False, GmainsqlParameters)
            '' ''    .SetAllBusinessUiInitialValue(Me)
            '' ''    '' .SaveDataMessage(Me)
            '' ''End With
