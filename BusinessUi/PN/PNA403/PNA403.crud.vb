...
Namespace ubiLease.UI.BusinessUi.PN
    Partial Class PNA403
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACouponCorpNm", Me.txtCouponCorpNm.Text)

            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA403_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If MsgBox("저장하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA403_CUD", True, False, GmainsqlParameters)
