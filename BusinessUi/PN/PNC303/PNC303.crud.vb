    ...
    Partial Class PNC303
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                .SetSqlParameter(GmainsqlParameters, "@AIngStateCd", Me.cboingstateCd.TextValue)
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC303_R", False, True, GmainsqlParameters)
