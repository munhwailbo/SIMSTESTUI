    ...
    Partial Class PNI322
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI322_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNum"), .get_ColIndex("SubscriptionAmt"), "{0} 소계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNum"), .get_ColIndex("DeductAmt"), "{0} 소계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNum"), .get_ColIndex("TransferAmt"), "{0} 소계")
                    ...
                    '.set_MergeCol(Me.grd_1.get_ColIndex("ChargeEmpNm"), True)
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("ChargeEmpNm"), .get_ColIndex("SubscriptionAmt"), "{0} 소계")
        ...
        Public Sub SaveData()
            ...
            ' '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNI322_CUD", True, False, GmainsqlParameters)
            ' '' ''    .SetAllBusinessUiInitialValue(Me)
            ' '' ''    '' .SaveDataMessage(Me)
            ' '' ''End With
