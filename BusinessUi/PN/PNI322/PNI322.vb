...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Public Class PNI322
        ...
        Private Sub PNI322_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|지대년월;PROCDT;60;;l;" & "o;n;n;6;"       '(10)
            gridAttributes = gridAttributes & "|번호;RowNumber;80;#,##0;c;" & "o;n;n;15;"       '(80)

            gridAttributes = gridAttributes & "|구분;GuBun;80;;l;" & "o;n;n;15;"       '(80)
            gridAttributes = gridAttributes & "|구독처;ColRemark;60;;l;" & "o;n;n;6;"       '(10)
            'gridAttributes = gridAttributes & "|구독처;Remark;60;;l;" & "o;n;y;6;"       '(10)
            gridAttributes = gridAttributes & "|대상년월;CalYearMonths;60;;l;" & "o;n;n;6;"       '(10)
            gridAttributes = gridAttributes & "|부수;PaperNum;80;#,##0;r;" & "o;n;n;15;"       '(80)
            gridAttributes = gridAttributes & "|지급액;SubscriptionAmt;80;#,##0;r;" & "o;n;n;15;"       '(80)
            gridAttributes = gridAttributes & "|지대대체;DeductAmt;80;#,##0;r;" & "o;n;n;15;"       '(80)
            gridAttributes = gridAttributes & "|이체금액;TransferAmt;80;#,##0;r;" & "o;n;n;15;"       '(80)
