...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Partial Class PNE411
        ...
        Public Sub NewData()
            ...
            Me.dtpProcDt.TextValue = "20081130" '''''System.DateTime.Now
            Me.popProcEmpNum.TextValue = GmainBusinessFunction.GetValue("로그인 ID")

            popCompanyCd.TextValue = popCompanyCd_R.TextValue
            popEmployeeExpNum.TextValue = popEmployeeExpNum_R.TextValue
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE411_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("DemandAmt"), "합계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("CollectionAmt"), "합계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("DistributionAmt"), "합계")

                    .set_TextMatrix(.FixedRows, .get_ColIndex("ProcDt"), "합   계")
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                .SetSqlParameter(GmainsqlParameters, "@AProcDt", Me.grd_1.GetCurrentRowCellValue("ProcDt"))
                .SetSqlParameter(GmainsqlParameters, "@AProcOrders", Me.grd_1.GetCurrentRowCellValue("ProcOrders"))
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE411_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcDt", Me.dtpProcDt.TextValue)  '' 입급일자    
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcOrders", Me.numProcOrders.TextValue)  '' 입금순번     
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcTypeCd", Me.cboColTypeCd.TextValue)  '' 입금구분코드 
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", Me.dtpCalYearMonths.TextValue)  '' 입금금액     
            ...
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ADemandAmt", Me.numDemandAmt.TextValue)  '' 입금금액     
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACollectionAmt", Me.numCollectionAmt.TextValue)  '' 입금금액     
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ADistYearMonths", Me.dtpDistYearMonths.TextValue)  '' 배분년월     
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ADistributionAmt", Me.numDistributionAmt.TextValue)  '' 배분액
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE411_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub DeleteData()
            ...
            If MsgBox("삭제하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ARecordProcessMode", "3")    '상태코드
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcDt", Me.dtpProcDt.TextValue)  '' 입급일자    
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcOrders", Me.numProcOrders.TextValue)  '' 입금순번     
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcTypeCd", Me.cboColTypeCd.TextValue)  '' 입금구분코드 
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", Me.dtpCalYearMonths.TextValue)  '' 입금금액     
                ...
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACollectionAmt", Me.numCollectionAmt.TextValue)  '' 입금금액     
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ADistYearMonths", Me.dtpDistYearMonths.TextValue)  '' 배분년월     
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ADistributionAmt", Me.numDistributionAmt.TextValue)  '' 입금금액     
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcEmpNum", Me.popProcEmpNum.TextValue)  '' 작업자 사번  
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ANote", Me.txtNote.TextValue)  '' 비고         
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AloginId", GmainBusinessFunction.GetValue("로그인 ID"))
        ...
        Public Sub ExportData()
            ...
            '' ''    .SetExportCrystalDataParameter("PNE411_1_C_R.rpt", "PNE411_1_C_R", "", AsqlParameters, AformulaParameters)
            '' ''End With
