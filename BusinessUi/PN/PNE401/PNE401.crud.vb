    ...
    Partial Class PNE401
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                .SetSqlParameter(GmainsqlParameters, "@ABillDivCd", Me.cboBillDivCd_R.TextValue)   '' 청구방법
                .SetSqlParameter(GmainsqlParameters, "@ACompanyCd", Me.popCompanyCd.TextValue)     '' 확장처 
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE401_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    '.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("SubsUnitAmt"), "합계")
                    ...
                    '' '' '' 그리드 지국별 소계행 추가
                    ' '' =============================================================================
                    .Styles(C1.Win.C1FlexGrid.CellStyleEnum.Subtotal2).BackColor = Color.LightCyan
                    .Styles(C1.Win.C1FlexGrid.CellStyleEnum.Subtotal2).ForeColor = Color.Blue
                    '.set_MergeCol(Me.grd_1.get_ColIndex("ChargeEmpNm"), True)
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNm"), .get_ColIndex("PaperNum"), "{0} 계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNm"), .get_ColIndex("SubscriptionAmt"), "{0} 계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNm"), .get_ColIndex("DeductAmt"), "{0} 계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 2, .get_ColIndex("BranchNm"), .get_ColIndex("TransferAmt"), "{0} 계")
                    ...
                    '.set_MergeCol(Me.grd_1.get_ColIndex("ChargeEmpNm"), True)
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("EmployeeNameHangul"), .get_ColIndex("PaperNum"), "{0} 소계")
                    '.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("EmployeeNameHangul"), .get_ColIndex("SubsUnitAmt"), "{0} 소계")   '단가계
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("EmployeeNameHangul"), .get_ColIndex("SubscriptionAmt"), "{0} 소계")
                    ...
                    '    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 1, .get_ColIndex("EmployeeNameHangul"), intII, "{0} 소계")
                    'Next
                    ...
                    '.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("SubsUnitAmt"), "합계")   '단가계 
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("SubscriptionAmt"), "합계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("DeductAmt"), "합계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("TransferAmt"), "합계")
        ...
        Public Sub SaveData()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE401_CUD", True, False, GmainsqlParameters)
                .SetAllBusinessUiInitialValue(Me)
                '' .SaveDataMessage(Me)
            End With
        ...
        Public Sub SaveData2()
            ...
            ' '' ''    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNE401_2_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData()
            ...
            'With GmainCommonFunction
            '    .SetSqlParameter(AsqlParameters, "@AYYYYMM", Me.dtpBaseYearMonths.TextValue)
            ...
            '    .SetExportCrystalDataParameter("PNE401_1_C_R.rpt", "PNE401_1_C_R", "", AsqlParameters, AformulaParameters)
            'End With
