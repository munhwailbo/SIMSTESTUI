    ...
    Partial Class PNA101
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA101_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If grd_1.CheckNeedValue(grd_1) Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA101_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData()
            ...
            With GmainCommonFunction
                ...
                .SetExportCrystalDataParameter("PNA101.rpt", "PNA101_R", "", AsqlParameters, AformulaParameters)
            End With
