    ...
    Partial Class PNA101
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA101_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData_2()
            ...
            With GmainCommonFunction
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNA101_2_CUD", True, False, GmainsqlParameters)
