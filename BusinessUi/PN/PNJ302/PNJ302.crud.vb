...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Partial Class PNJ302
        ...
        Public Sub NewData()
            ...
            Me.dtpColDt.TextValue = System.DateTime.Now
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", Me.dtpCalYearMonths_R.TextValue)
                '' ''GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AColYearMonths", Me.dtpColYearMonths_R.TextValue)
                ...
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACouponCorpCd", Me.popCouponCorpCd_R.TextValue)

                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNJ302_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNJ302_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", IIf(IsNothing(Me.dtpCalYearMonths.TextValue), "", Me.dtpCalYearMonths.TextValue))  ''지대청구년월 
            '' ''GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AColYearMonths", IIf(IsNothing(Me.dtpColYearMonths.TextValue), "", Me.dtpColYearMonths.TextValue))  ''지대수금년월 
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACouponCorpCd", Me.popCouponCorpCd.TextValue)  '' 소속사 코드 
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNJ302_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub DeleteData()
            ...
            If MsgBox("삭제하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", IIf(IsNothing(Me.dtpCalYearMonths.TextValue), "", Me.dtpCalYearMonths.TextValue))  ''지대청구년월 
                ' ''GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AColYearMonths", IIf(IsNothing(Me.dtpColYearMonths.TextValue), "", Me.dtpColYearMonths.TextValue))  ''지대수금년월 
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ACouponCorpCd", Me.popCouponCorpCd.TextValue)  '' 소속사코드 
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AColAmt", Me.numColAmt.TextValue)  '' 입금금액     
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AProcEmpNum", Me.popProcEmpNum.TextValue)  '' 작업자 사번  
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@ANote", Me.txtNote.TextValue)  '' 비고         
                GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AloginId", GmainBusinessFunction.GetValue("로그인 ID"))
        ...
        Public Sub ExportData()
            ...
            '' ''    .SetExportCrystalDataParameter("PNJ302_1_C_R.rpt", "PNJ302_1_C_R", "", AsqlParameters, AformulaParameters)
            '' ''End With
