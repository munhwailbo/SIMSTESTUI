...
Namespace ubiLease.UI.BusinessUi.PN
    Partial Class PNC501
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC501_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If MsgBox("저장하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "PNC501_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData()
            ...
            With GmainCommonFunction
                ...
                .SetExportCrystalDataParameter("PNC501_C_R.rpt", "PNC501_C_R;PNC501_1_C_R;", "", AsqlParameters, AformulaParameters)
            End With
