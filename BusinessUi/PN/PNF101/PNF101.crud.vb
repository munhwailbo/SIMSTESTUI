...
Namespace ubiLease.UI.BusinessUi.PN
    ...
    Partial Class PNF101
        ...
        Public Sub NewData()
            ...
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("JanGoalPapeNum"), "0")   '' 1월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("FebGoalPaperNum"), "0")   '' 2월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("MarGoalPaperNum"), "0")   '' 3월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("AprGoalPaperNum"), "0")   '' 4월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("MayGoalPaperNum"), "0")   '' 5월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("JunGoalPaperNum"), "0")   '' 6월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("JulGoalPaperNum"), "0")   '' 7월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("AugGoalPaperNum"), "0")   '' 8월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("SepGoalPaperNum"), "0")   '' 9월목표부수   
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("OctGoalPaperNum"), "0")   '' 10월목표부수  
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("NovGoalPaperNum"), "0")   '' 11월목표부수  
            grd_1.set_TextMatrix(grd_1.Rows - 1, grd_1.get_ColIndex("DecGoalPaperNum"), "0")   '' 12월목표부수  
        End Sub
        ''' <summary>
        ''' 함수명 : RequestData
        ''' 기  능 : 조회
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                .SetSqlParameter(GmainsqlParameters, "@AChargeEmpNum", Me.popChargeEmpNum.TextValue)   ' 영업담당
                .SetSqlParameter(GmainsqlParameters, "@ABranchNm", Me.txtBranchNm.TextValue)  '담당지국
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    For intII As Integer = .get_ColIndex("GoalPaperNum") To .get_ColIndex("DecGoalPaperNum")
                        .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, intII, "합계")
                    Next
