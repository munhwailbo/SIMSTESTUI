...
Namespace ubiLease.UI.BusinessUi.CO
    ...
    Public Class SMBB01
        ...
        Public Sub Initialize()
            ...
            'gridAttributes = gridAttributes & "|조직구분;EmployeeNumber;100;;c;" & "io;n;n;6;"

            'gridAttributes = gridAttributes & "|지점;BranchCode;50;;c;" & "io;n;n;2;"
            'gridAttributes = gridAttributes & "|팀;TeamCode;50;;c;" & "io;n;n;2;"
            'gridAttributes = gridAttributes & "|파트;PartCode;50;;c;" & "io;n;n;2"
            'gridAttributes = gridAttributes & "|PC;PCCode;50;;c;" & "io;n;n;2;"
            'gridAttributes = gridAttributes & "|코너;CornerCode;50;;c;" & "io;n;n;2;"
            'gridAttributes = gridAttributes & "|조직명;CodeName;100;;l;" & "io;n;n;100;"
            ...
            gridAttributes = gridAttributes & "|조직명;CodeName;100;;l;" & "io;n;n;100;"
            gridAttributes = gridAttributes & "|최종 여부;LastYesOrNo;100;;c;" & "io;n;n;100;"
            gridAttributes = gridAttributes & "|사용 여부;PrivateUseYesOrNo;100;;c;" & "io;n;n;100;"
