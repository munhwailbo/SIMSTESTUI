...
Namespace ubiLease.UI.BusinessUi.CO
    ...
    Partial Class SMBB01
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("SM","SMBB01_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("SM","SMBB01_CUD", True, False, GmainsqlParameters)
