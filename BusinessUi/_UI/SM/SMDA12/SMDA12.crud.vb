...
Namespace ubiLease.UI.BusinessUi.SM
    ...
    Partial Class SMDA12
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("SM","SMDA12_R", False, True, GmainsqlParameters)
            ...
            If reciveDataSet.Tables(1).Rows.Count <> 0 Then
                With reciveDataSet.Tables(1)
                    For intII = 3 To .Columns.Count - 1
                        intCol += 1
                        colName = ""
                        colName = "EmployeeNumber_" & VBN.Right("000" & CStr(intCol), 3)
