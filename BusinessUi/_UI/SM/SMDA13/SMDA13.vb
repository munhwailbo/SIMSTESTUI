...
Namespace ubiLease.UI.BusinessUi.SM
    ...
    Public Class SMDA13
        ...
        Private Sub SMDA13_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|사원번호;EmployeeNumber;100;;l;" & "o;n;n;6;"
            gridAttributes = gridAttributes & "|사원 명;EmployeeNameHangul;100;;l;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|파트 코드;PartCode;100;;c;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|파트 명;PartName;100;;c;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|총계;Tot;100;#,##0;c;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|프로그램명;EmployeeNumber;100;;c;" & "o;n;n;6;"
        ...
        Public Sub DynamicInitialize(ByRef reciveDataSet As DataSet)
            ...
            If reciveDataSet.Tables(1).Rows.Count <> 0 Then
                ...
                With reciveDataSet.Tables(1)
                    ...
                    For intII = 5 To .Columns.Count - 1
                        intCol += 1
                        strColName = .Rows(1).Item(intII).ToString
                        gridAttributes = gridAttributes & "|" & strColName & ";UiId_" & VBN.Right("000" & CStr(intCol), 3) & ";100;#,###;c;" & "o;n;n;50;"
                    Next
