    ...
    Partial Class BMA101
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "BMA101_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If Me.Validation = True Then
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PN", "BMA101_CUD", True, False, GmainsqlParameters)
            ...
            For intForNumber As Integer = 0 To Me.grd_1.Rows - 1
                If Me.grd_1.GetCellCheck(intForNumber, Me.grd_1.get_ColIndex("선택")) = CheckEnum.Checked Then
                    ...
                    If Me.grd_1.get_TextMatrix(intForNumber, Me.grd_1.get_ColIndex("MutualBranchCode")) = "" Then
                        ...
                        Exit Function
                    End If
                    If Me.grd_1.GetCellCheck(intForNumber, Me.grd_1.get_ColIndex("SubjectYON")) = CheckEnum.Checked Then
                        If IsDate(Me.grd_1.get_TextMatrix(intForNumber, Me.grd_1.get_ColIndex("JoinDate"))) = False Then
                            MessageBox.Show("가입일자를 다시 등록해 주세요", Me.Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                            Exit Function
                        End If
                    End If
