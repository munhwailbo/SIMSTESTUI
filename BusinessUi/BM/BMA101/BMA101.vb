...
#Region "폼 초기화"
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|가입(대상)여부;SubjectYON;1253;;l;" & "io;n;n;5;"
            gridAttributes = gridAttributes & "|가입일자;JoinDate;3000;####-##-##;l;" & "io;n;n;30;"
            ...
            'gridAttributes = gridAttributes & "|조직 코드;OrganizationCode;120;;l;" & "o;n;y;7;파트 명;OrganizationCodeName"
...
#Region "폼 이벤트"
        ...
        Private Sub BMA101_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub grd_1_EnterCell(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grd_1.EnterCell
            ...
            With Me.grd_1
                If .Rows > 1 Then
                    ...
                    If .GetCurrentRowCellValue("Orders") <> "0" Then
                        Select Case .ColSel
