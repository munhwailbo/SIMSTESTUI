    ...
    Partial Class PSF102 
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSF102_1_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            If MsgBox("전표 처리를 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSF102_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSF102.rpt", "PSF102_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
