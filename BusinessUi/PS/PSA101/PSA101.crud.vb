...
Namespace ubiLease.UI.BusinessUi.PS  
    ...
    Partial Class PSA101 
        ...
        Public Sub NewData() 
           ...
           ' '컨트롤 초기값 설정 
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSA101_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", dtpCalYearMonths_R.TextValue)  '' 정산시작년월
                .SetSqlParameter(GmainsqlParameters, "@AChargeEmpNum", popChargeEmpNum_R.TextValue)    ''영업담당자
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSA101_1_R", False, True, GmainsqlParameters)
        ...
        '    GmainsqlParameters = Nothing
        '    With GmainCommonFunction
        '        .SetSqlParameter(GmainsqlParameters, "@ACalYearMonths", dtpCalYearMonths.TextValue)  '' 정산시작년월
        '        .SetSqlParameter(GmainsqlParameters, "@AChargeEmpNum", popChargeEmpNum2_R.TextValue)  '' 영업담당자
        '        Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSA101_2_R", False, True, GmainsqlParameters)
		...
		Public Sub SaveData()  
            ...
            If MsgBox("저장하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSA101_CUD", True, False, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSA101.rpt", "PSA101_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
