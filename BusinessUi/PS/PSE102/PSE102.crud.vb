 ...
 '''' -------------------------------------------------------------------
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@ABaseYearMonths", dtpBaseYearMonths.TextValue)    ''정산년월
                .SetSqlParameter(GmainsqlParameters, "@AWeekNum", numWeekNum.TextValue)    ''차수
                .SetSqlParameter(GmainsqlParameters, "@AbranchNm", txtBranchNm.TextValue)    '지국명
                .SetSqlParameter(GmainsqlParameters, "@AemployeeNumber", popEmployeeNumber.TextValue)    ''배달비 구분
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSE102_1_R", False, True, GmainsqlParameters)
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    .set_TextMatrix(.FixedRows, .get_ColIndex("BranchNm"), "합   계")
        ...
        Public Sub SaveData()
            ...
            If MsgBox("전표 처리를 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSE102_CUD", True, False, GmainsqlParameters)
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSE102.rpt", "PSE102_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
