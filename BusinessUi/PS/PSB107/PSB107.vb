'//////////////////////////////////////////////////////////////////////////////////////////////////// 
' form 명 :  [PSB107] 업체 미수 선수 현황
' form 설명 :  [PSB107] 업체 미수 선수 현황
' 작성자 : 
' 작성일 : 2013-11-28 오후 5:07:27
'//////////////////////////////////////////////////////////////////////////////////////////////////// 
...
Namespace ubiLease.UI.BusinessUi.PS 
    ...
    Public Class PSB107 
        ...
        Private Sub PSB107_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load  
        ...
        Public Sub Initialize()  
            ...
            gridAttributes_1 = gridAttributes_1 & "|매출구분코드;SaleTypeCd;105;;1;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|업체;CustomerCode;62;;4;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|업체;CustomerNm;170;;1;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|업체;SimsCode;62;;4;" & "o;n;n;;"
            ...
            gridAttributes_1 = gridAttributes_1 & "|발행순번;PubSeq;0;;4;" & "io;n;y;;"
            gridAttributes_1 = gridAttributes_1 & "|미수금;Amt_11;100;#,##0;7;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|가수금;Amt_21;100;#,##0;7;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|가수금;Amt_22;100;#,##0;7;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|매출채권;Amt_31;100;#,##0;7;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|매출채권;Amt_32;100;#,##0;7;" & "o;n;n;;"
            ...
            '' '' 미수금(선수금)
            ''gridAttributes_1 = gridAttributes_1 & "|미수금;Amt_11;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            '' '' 가수금대체(가수금대체/미수잔액)
            ''gridAttributes_1 = gridAttributes_1 & "|가수금;Amt_21;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            ''gridAttributes_1 = gridAttributes_1 & "|가수금;Amt_22;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            '' '' 매출채권대체(매출채권대체/선수잔액)
            ''gridAttributes_1 = gridAttributes_1 & "|매출채권;Amt_31;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            ''gridAttributes_1 = gridAttributes_1 & "|매출채권;Amt_32;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            ...
            '''' ---미수금(선수금)
            strColName2 = strColName2 & ControlChars.Tab & "미수금"
            strColName2 = strColName2 & ControlChars.Tab & "가수금대체"
            strColName2 = strColName2 & ControlChars.Tab & "미수잔액"
            strColName2 = strColName2 & ControlChars.Tab & "매출채권대체"
            strColName2 = strColName2 & ControlChars.Tab & "선수잔액"
            '''' --- 
            ...
            dtpBaseDate_R.Text = Now.ToString()
            dtpPubYYmm_R.Text = ""
        End Sub 
        ...
        ''' 함수명 : PSB107_Enter 
        ''' 기  능 : 화면 전환(미수/선수)
        Private Sub PSB107_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Enter
            ...
            If ShareParameters(0) = Me.Name Then
                ...
                ''Me.dtpBaseDate_R.TextValue = Replace(ShareParameters(5), "-", "") '거래 일자                             
                Me.dtpBaseDate_R.TextValue = Now.ToString()
        ...
        Private Sub grd_1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grd_1.DoubleClick
            ...
            With Me.grd_1
                ...
                If sProgramID.ToString.Length > 0 Then
                    ...
                    sPubDateTo = dtpBaseDate_R.TextValue '기준일자2
