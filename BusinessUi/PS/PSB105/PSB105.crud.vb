...
Namespace ubiLease.UI.BusinessUi.PS  
 ...
 '''' -------------------------------------------------------------------
		...
		Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)  
           ...
           ' End If 
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSB105_1_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSB105_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData3(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSB105_3_R", False, True, GmainsqlParameters)
                Me.grd_2.SetDataSet(reciveDataSet)
                reciveDataSet = Nothing
        ...
        Private Sub SetSubTotal_2()
            With Me.grd_2
                If .Rows > .FixedRows Then
                    ...
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("FixedBusu"), "합계")
		...
		Public Sub SaveData()  
            ...
            If MsgBox("저장하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSB105_CUD", True, False, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSB105.rpt", "PSB105_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
