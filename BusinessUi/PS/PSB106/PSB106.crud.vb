...
Namespace ubiLease.UI.BusinessUi.PS  
		...
		Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)  
           ...
           ' End If 
            ...
            With GmainCommonFunction 
                .SetSqlParameter(GmainsqlParameters, "@APubYYmm", dtpPubYYmm_R.TextValue)    ''PubYYmm
                .SetSqlParameter(GmainsqlParameters, "@ASaleTypeCd", cboSaleTypeCd_R.TextValue)    ''SaleTypeCd
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSB106_1_R", False, True, GmainsqlParameters) 
        ...
        Private Sub SetSubTotal()
            With Me.grd_1
                If .Rows > .FixedRows Then
                    ...
                    '' '' '' 그리드 합계행 추가
                    '' '' =============================================================================
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("SupplyAmt"), "합계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("TaxAmt"), "합계")
                    .Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Sum, 0, -1, .get_ColIndex("TotalAmt"), "합계")
		...
		Public Sub SaveData()  
            ...
            If MsgBox("전표 처리를 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSB106_CUD", True, False, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSB106.rpt", "PSB106_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
