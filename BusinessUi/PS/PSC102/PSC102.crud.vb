...
Namespace ubiLease.UI.BusinessUi.PS  
 ...
 '''' -------------------------------------------------------------------
		...
		Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)  
           ...
           ' End If 
            ...
            With GmainCommonFunction 
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSC102_1_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            lblTitle2.Text = "<처리대상 : 계산서 조회>"
            grd_2.Rows = grd_2.FixedRows
            GmainsqlParameters = Nothing
            With GmainCommonFunction
                .SetSqlParameter(GmainsqlParameters, "@ACustomerCode", popCustomerCode_R.TextValue)    ''발행년월
                .SetSqlParameter(GmainsqlParameters, "@ASaleTypeCd", cboSaleTypeCd_R.TextValue)    ''매출구분코드
                .SetSqlParameter(GmainsqlParameters, "@APubDateFr", dtpSaleDateFr_R.TextValue)  '' 매출시작일자
                .SetSqlParameter(GmainsqlParameters, "@APubDateTo", dtpSaleDateTo_R.TextValue)  '' 매출종료일자
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSC102_2_R", False, True, GmainsqlParameters)
        ...
        Public Sub RequestData3(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                .SetSqlParameter(GmainsqlParameters, "@APubDateFr", dtpSaleDateFr_R.TextValue)  '' 매출시작일자
                .SetSqlParameter(GmainsqlParameters, "@APubDateTo", dtpSaleDateTo_R.TextValue)  '' 매출종료일자
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSC102_3_R", False, True, GmainsqlParameters)

                Me.grd_2.SetDataSet(reciveDataSet)
                'If GmainExecuteDbCommand.GerrorNumber = 0 Then
                '    picTitle2.BackColor = Color.Lavender
                'End If
                reciveDataSet = Nothing
        ...
        Public Sub RequestData_2(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSC101_3_R", False, True, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
		...
		Public Sub SaveData()  
			...
			With GmainCommonFunction 
                ...
                GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSC102_CUD", True, False, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
		...
		Public Sub DeleteData()  
            ...
            If lblTitle2.Text <> "<매출 상세>" Then Exit Sub
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSC102.rpt", "PSC102_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
