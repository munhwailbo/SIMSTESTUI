'//////////////////////////////////////////////////////////////////////////////////////////////////// 
' form 명 :  [PSB104] 매출구조(계획)등록
' form 설명 :  [PSB104] 매출구조(계획)등록
' 작성자 : 
' 작성일 : 2013-11-28 오후 5:06:29
'//////////////////////////////////////////////////////////////////////////////////////////////////// 
...
Namespace ubiLease.UI.BusinessUi.PS 
    ...
    Public Class PSB104 
        ...
        Private Sub PSB104_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load  
        ...
        Public Sub Initialize()  
            ...
            gridAttributes_2 = gridAttributes_2 & "|계산서발행년월;PubYYmm;6;;c;" & "io;n;y;;"  '' SalePlan.PubYYmm 
            gridAttributes_2 = gridAttributes_2 & "|발행순번;PubSeq;0;;c;" & "io;n;y;;"  '' SalePlan.PubSeq 
            gridAttributes_2 = gridAttributes_2 & "|계산서번호;TaxNumber;0;;l;" & "o;n;n;;"  '' TotalTaxD.PubSeq 
            gridAttributes_2 = gridAttributes_2 & "|순번;PlanSeq;8;;c;" & "io;n;n;;"  '' SalePlan.PlanDate 
            gridAttributes_2 = gridAttributes_2 & "|매출계획일자;PlanDate;8;;c;" & "io;n;n;;"  '' SalePlan.PlanDate 
            gridAttributes_2 = gridAttributes_2 & "|매출계획금액;SalePlanAmt;19;#,##0;r;" & "io;n;n;;"  '' SalePlan.SalePlanAmt 
