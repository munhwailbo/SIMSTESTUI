...
Namespace ubiLease.UI.BusinessUi.PS  
		...
		Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)  
           ...
           ' End If 
            ...
            With GmainCommonFunction 
                .SetSqlParameter(GmainsqlParameters, "@ADeduYYMM", Me.dtpDeduYYmm.TextValue)    ''정산년월
                .SetSqlParameter(GmainsqlParameters, "@AbranchNm", Me.popBranchCd_R.TextValue)    ''정산년월
                .SetSqlParameter(GmainsqlParameters, "@ADeduType", Me.cboDeduType_R.TextValue)    ''정산년월
                .SetSqlParameter(GmainsqlParameters, "@AemployeeNumber", Me.popChargeEmpNum_R.TextValue)    ''공제구분코드
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSE103_1_R", False, True, GmainsqlParameters) 
		...
		Public Sub SaveData()  
            ...
            If MsgBox("전표 처리를 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    .SetSqlParameter(GmainsqlParameters, "@ADeduType", Me.cboDeduType_R.TextValue)
                    .SetSqlParameter(GmainsqlParameters, "@AloginId", GmainBusinessFunction.GetValue("로그인 ID"))
                    .SetSqlParameter(GmainsqlParameters, "@AxmlContext", Me.grd_1.GetXmlData(False))

                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSE103_CUD", True, False, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSE103.rpt", "PSE103_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
