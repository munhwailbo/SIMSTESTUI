...
Namespace ubiLease.UI.BusinessUi.PS  
		...
		Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)  
           ...
           ' End If 
            ...
            With GmainCommonFunction 
                .SetSqlParameter(GmainsqlParameters, "@AEpReceiptDateFr", dtpReceiptDateFr_R.TextValue)    ''수납시작일자
                .SetSqlParameter(GmainsqlParameters, "@AEpReceiptDateTo", dtpReceiptDateTo_R.TextValue)    ''수납종료일자
                .SetSqlParameter(GmainsqlParameters, "@ASaleTypeCd", cboSaleTypeCd_R.TextValue)    ''SaleTypeCd
                .SetSqlParameter(GmainsqlParameters, "@ACustomerCode", popCustomerCode_R.TextValue)    ''SaleTypeCd    ''수납종료일자

                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSD105_1_R", False, True, GmainsqlParameters) 
		...
		Public Sub SaveData()  
            ...
            If MsgBox("전표 처리를 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSD105_CUD", True, False, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSD105.rpt", "PSD105_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
