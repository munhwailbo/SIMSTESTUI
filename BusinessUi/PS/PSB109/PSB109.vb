'//////////////////////////////////////////////////////////////////////////////////////////////////// 
' form 명 :  [PSB109] 업체 선수 내역
' form 설명 :  [PSB109] 업체 선수 내역
' 작성자 : 
' 작성일 : 2013-11-28 오후 5:07:32
'//////////////////////////////////////////////////////////////////////////////////////////////////// 
...
Namespace ubiLease.UI.BusinessUi.PS 
    ...
    Public Class PSB109 
        ...
        Private Sub PSB109_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load  
        ...
        Public Sub Initialize()  
            ...
            gridAttributes_1 = gridAttributes_1 & "|금   액;Amt_31;100;#,##0;7;" & "o;n;n;;"
            gridAttributes_1 = gridAttributes_1 & "|금   액;Amt_32;100;#,##0;7;" & "o;n;n;;"
            ...
            ''gridAttributes_1 = gridAttributes_1 & "|업   체;CustomerCode;7;;c;" & "o;n;n;;"  '' TotalTax.CustomerCode 
            ''gridAttributes_1 = gridAttributes_1 & "|업   체;CustomerNm;7;;l;" & "o;n;n;;"  '' TotalTax.CustomerCode 
            ''gridAttributes_1 = gridAttributes_1 & "|업   체;SimsCode;7;;c;" & "o;n;n;;"  '' TotalTax.CustomerCode 
            ...
            ' '' '' 가수금대체(가수금대체/미수잔액)
            '' ''gridAttributes_1 = gridAttributes_1 & "|가수금대체(B);Amt_21;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            '' ''gridAttributes_1 = gridAttributes_1 & "|잔액(A-B);Amt_22;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            ' '' 매출채권대체(매출채권대체/선수잔액)
            ''gridAttributes_1 = gridAttributes_1 & "|금   액;Amt_31;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            ''gridAttributes_1 = gridAttributes_1 & "|금   액;Amt_32;19;#,##0;r;" & "o;n;n;;"  '' TotalTax.SupplyAmt 
            ...
            '''' ---미수금(선수금)
            strColName2 = strColName2 & ControlChars.Tab & "선수금(A)"
            strColName2 = strColName2 & ControlChars.Tab & "매출채권대체(B)"
        ...
        ''' 함수명 : PSB109_Enter 
        ''' 기  능 : 화면 전환(미수/선수)
        Private Sub PSB109_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Enter
