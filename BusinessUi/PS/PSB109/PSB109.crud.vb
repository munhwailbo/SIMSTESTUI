    ...
    Partial Class PSB109 
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            With GmainCommonFunction
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSB109_1_R", False, True, GmainsqlParameters)
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSB109.rpt", "PSB109_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
