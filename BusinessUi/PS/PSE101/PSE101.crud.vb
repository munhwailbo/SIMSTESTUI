...
Namespace ubiLease.UI.BusinessUi.PS  
		...
		Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)  
           ...
           ' End If 
            ...
            With GmainCommonFunction 
                ...
                Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSE101_1_R", False, True, GmainsqlParameters) 
		...
		Public Sub SaveData()  
            ...
            If MsgBox("전표 처리를 하시겠습니까?", MsgBoxStyle.OkCancel, "선택하세요.") = MsgBoxResult.Ok Then
                ...
                With GmainCommonFunction
                    ...
                    GmainExecuteDbCommand.ExecuteStoredProcedure("PS", "PSE101_CUD", True, False, GmainsqlParameters)
 ...
 '''' -------------------------------------------------------------------
        ...
        Public Sub ExportData() 
         ...
         '       .SetExportCrystalDataParameter("PSE101.rpt", "PSE101_R", "", AsqlParameters, AformulaParameters) 
         '   End With 
