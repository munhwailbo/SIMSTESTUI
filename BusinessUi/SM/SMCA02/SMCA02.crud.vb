...
Namespace ubiLease.UI.BusinessUi.CO
    ...
    Partial Class SMCA02
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            GmainCommonFunction.SetSqlParameter(GmainsqlParameters, "@AOrganizationCode", Me.popEarningsOrganizationCode.TextValue)

            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("SM","SMCA02_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("SM","SMCA02_CUD", True, False, GmainsqlParameters)
