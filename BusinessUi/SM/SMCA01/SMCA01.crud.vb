...
Namespace ubiLease.UI.BusinessUi.SM
    ...
    Partial Class SMCA01
        ...
        Public Sub RequestData(Optional ByVal AprocessMessage As Boolean = True)
            ...
            Dim reciveDataSet As DataSet = GmainExecuteDbCommand.ExecuteStoredProcedure("SM","SMCA01_R", False, True, GmainsqlParameters)
        ...
        Public Sub SaveData()
            ...
            GmainExecuteDbCommand.ExecuteStoredProcedure("SM","SMCA01_CUD", True, False, GmainsqlParameters)
