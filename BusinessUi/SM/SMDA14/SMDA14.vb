...
Namespace ubiLease.UI.BusinessUi.SM
    ...
    Public Class SMDA14
        ...
        Private Sub SMDA14_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Public Sub Initialize()
            ...
            gridAttributes = gridAttributes & "|역할 코드;RoleCode;100;;c;" & "o;n;n;6;"
            gridAttributes = gridAttributes & "|역할 명;RoleName;100;;c;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|총계;Tot;100;#,##0;c;" & "o;n;n;30;"
            gridAttributes = gridAttributes & "|프로그램 명;EmployeeNumber;100;;c;" & "o;n;n;6;"
        ...
        Public Sub DynamicInitialize(ByRef reciveDataSet As DataSet)
            ...
            If reciveDataSet.Tables(1).Rows.Count <> 0 Then
                ...
                With reciveDataSet.Tables(1)
                    ...
                    gridAttributes = gridAttributes & "|역할 코드;RoleCode;100;;l;" & "o;n;n;6;"
                    gridAttributes = gridAttributes & "|역할 명;RoleName;100;;l;" & "o;n;n;30;"
                    gridAttributes = gridAttributes & "|총계;Tot;100;#,##0;c;" & "o;n;n;30;"
